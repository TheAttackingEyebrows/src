...
public class BlockchainServer {
    ...
    public static void main(String[] args) {
        ...
        Thread st = new Thread(new CatchUpRRunnable(new ServerInfo(remoteHost, remotePort), blockchain, -1));
        st.start();
        try{
            st.join();
        }
        ...
        new Thread(new PeriodicSupRunnable(serverStatus, blockchain, localPort)).start();
